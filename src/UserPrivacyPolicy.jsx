...
export function UserPrivacyPolicy() {
    return (
        <AppShell bg="dark.6">
            {/* Header Section */}
            <Box
            ...
            <Container size="md" py={40}>
                ...
                <Box mb={30}>
                    <Title order={2} size="h3" mb={15}>User Account Management</Title>
                    <Text mb={15}>
                        We provide users with the following account management options:
                    </Text>
                    <Text component="ul" mb={15}>
                        <li><strong>Account Creation:</strong> Users must be at least 16 years old and provide accurate information during registration.</li>
                        <li><strong>Account Deletion:</strong> Users can request complete account deletion at any time by sending an email to <a href="mailto:team@dormdash.app">team@dormdash.app</a>. 
                        Please include the following in your deletion request:
                            <ul>
                                <li>Registered email address</li>
                                <li>Reason for account deletion (optional)</li>
                            </ul>
                        We will process your account deletion request promptly.
                        </li>
                    </Text>
                </Box>
